...
La release attuale è una **build sperimentale 0.40.0 ARM64**, distribuita fuori
...
La 0.40.0 usa OpenStreetMap come ossatura geometrica della sola rete escursionistica. Dati di parchi e CAI qualificano prioritariamente codici, nomi, difficoltà e ufficialità; una geometria esterna viene pubblicata soltanto quando il percorso non è presente in modo significativo nella rete OSM. Gli itinerari ufficiali dei parchi e quelli CAI costituiscono la rete primaria, mentre gli altri sentieri e le deviazioni formano la rete secondaria.

La distribuzione usa un solo APK completo: `02-Sentieri-Abruzzo-0.40-arm64.apk`. Non esiste più un APK ponte: il pacchetto unico include
