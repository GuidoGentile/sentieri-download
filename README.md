...
La release attuale è una **build sperimentale 0.37.0 ARM64**, distribuita fuori
...
La distribuzione usa un solo APK completo: `02-Sentieri-Abruzzo-0.37-arm64.apk`. Non esiste più un APK ponte: il pacchetto unico include
