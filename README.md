...
La release attuale è una **build sperimentale 0.11.3 ARM64 di aggiornamento** (circa 30 MB), distribuita fuori
...
deve ancora essere validato con prove reali sul campo. La 0.11.3 riusa i dati cartografici estratti
