...
La release attuale è una **build sperimentale 0.12.1 ARM64 di aggiornamento** (circa 30 MB), distribuita fuori
...
è stato provato sul campo in una prima registrazione reale, ma richiede ulteriori collaudi. La 0.12.1
riusa i dati cartografici della 0.12.0 completa: per una prima installazione occorre installare la
0.12.0 e aprire almeno una mappa, quindi applicare la 0.12.1 senza disinstallare l'app.
